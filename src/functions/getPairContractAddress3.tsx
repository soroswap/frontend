...
export async function getPairContractAddress3(address_1:string, address_2:string, sorobanContext: SorobanContextType) {
    ...
    let result = await server.simulateTransaction(paymentResult)
