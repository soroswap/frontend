...
const BaseWrapper = styled('div')<{ disable?: boolean }>`
  border: 1px solid ${({ theme, disable }) => (disable ? "#4C82FB" : opacify(24, "#98A1C0"))};
  border-radius: 16px;
  display: flex;
  padding: 6px;
  padding-right: 12px;
  ...
  :hover {
    ...
    background-color: ${({ theme }) => opacify(8, "#98A1C0")};
  }

  color: ${({ theme, disable }) => disable && "#4C82FB"};
  background-color: ${({ theme, disable }) => disable && opacify(24, "#4C82FB")};
`
