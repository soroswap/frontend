...
import {contractTransaction, useContractValue, useSendTransaction} from '@soroban-react/contracts'
import {
    accountToScVal, bigNumberToI128,
  } from '../../helpers/utils';
...
export function DepositButton({
  ...
  amount0, 
  amount1, 
  sorobanContext}:DepositButtonProps){
    ...
    const depositTokens = async () => {
        ...
        try {
          ...
          let tx = contractTransaction({
            ...
            method: 'deposit',
            params: [new SorobanClient.Address(account).toScVal(), amount0ScVal, amount0ScVal, amount1ScVal, amount1ScVal]
          })
          ...
          console.log("🚀 ~ file: DepositButton.tsx ~ depositTokens ~ result:", result)
