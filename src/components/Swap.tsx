  ...
  const inputToOutput = (n: number) => {
    if (inputToken.value == currencies[0].value) {
      if (balancesBigNumber) {
        ...
        let ra =
          parseInt(balancesBigNumber.liquidityPoolBalance_1.toString()) /
          10000000;
        let rb =
          parseInt(balancesBigNumber.liquidityPoolBalance_2.toString()) /
          10000000;
  ...
  return (
    <Card sx={{ maxWidth: 345 }}>
      <CardContent>
        ...
        <p>.</p>
        <p>
          1 {inputToken.label} = {inputToOutput(1)} {outputToken.label}
        </p>
      </CardContent>
      <CardActions>
        <SwapButton
