...
export async function contractInvoke({
  ...
  console.log("🚀 ~ file: contractInvoke.tsx:54 ~ networkPassphrase:", networkPassphrase)
  let source = null
  console.log("🚀 ~ file: contractInvoke.tsx:56 ~ source:", source)
  ...
  console.log("🚀 ~ file: contractInvoke.tsx:80 ~ txn:", txn)

  const simulated: SorobanRpc.Api.SimulateTransactionResponse =
  await server?.simulateTransaction(txn)
  console.log("🚀 ~ file: contractInvoke.tsx:83 ~ simulated:", simulated)
  ...
  if (!signAndSend && simulated) {
    ...
    console.log("🚀 ~ file: contractInvoke.tsx:102 ~ res:", res)
